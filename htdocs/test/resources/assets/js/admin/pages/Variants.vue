<template>
  <div>
    <bs-filter name="variants" :current-filter="filter" @apply="applyFilter()" @clear="clearFilter()">
      <div class="col-xs-6">
    ...
    <vudal name="variant">
      <div class="header">
        ...
        <h4 class="modal-title" v-if="current.id == null">Создание варианта</h4>
        <h4 class="modal-title" v-else>Редактирование варианта</h4>
      </div>
      <div class="content">
        <form>
          <div class="row">
...
import Variant from '_shared/resources/admin/Variant';
...
export default {
  ...
  methods: {
    filterFilterDisciplines() {
      this.filterDisciplines = this.meta.disciplines.filter(variant =>
